...
- **Share** publishes a theme to a plugin repository so other panels can install it. If the theme uses a layout template, the template is included and the two are published together as a **theme bundle**. Step-by-step: [Sharing Plugins](../using-tcadmin/common/sharing-plugins.mdx).
