...
That user only allows logins from the master itself; when you add remote servers, you'll create a second grant for their IPs (see [Step 1 of Remote Server Configuration](remote-server-configuration.mdx#step-1-let-remote-servers-reach-the-masters-database-and-redis)).
:::
