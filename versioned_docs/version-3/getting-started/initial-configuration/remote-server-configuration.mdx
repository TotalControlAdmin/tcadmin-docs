...
Before the remote server can connect, you need to tell the master server to share its database and Redis connection details. You only do this once, on the master.
