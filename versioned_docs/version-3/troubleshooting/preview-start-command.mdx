...
This works the same way for native Windows, native Linux, [Wine](../using-tcadmin/games/cross-os-game-servers/wine-support.mdx), and [WSL](../using-tcadmin/games/cross-os-game-servers/wsl-support.mdx) services.
